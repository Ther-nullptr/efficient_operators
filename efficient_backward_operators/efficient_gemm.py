...
class EfficientMemoryGEMMFunc(torch.autograd.Function):
    ...
    def backward(ctx, grad_output, grad_outliner_1, grad_R1, grad_Rinv1, grad_outliner_2, grad_R2, grad_Rinv2):
        ...
        x1 = true_divide_outliner_suboutlinear_svd_decompress(x1_outlier_compressed, L1, R1, True, ctx.num_heads)
        x2 = true_divide_outliner_suboutlinear_svd_decompress(x2_outlier_compressed, L2, R2, True, ctx.num_heads).mT
...
class EfficientMemoryGEMMWithSoftmaxFunc(torch.autograd.Function):
    ...
    def forward(
        ...
        ctx.num_heads = num_heads
        ctx.mark_non_differentiable(outliner_1, outliner_2, R2, Rinv2)
    ...
    def backward(ctx, grad_output, grad_outliner_1, grad_outliner_2, grad_R2, grad_Rinv2):
        ...
        x2 = true_divide_outliner_suboutlinear_svd_decompress(x2_outlier_compressed, L2, R2, True, ctx.num_heads)
