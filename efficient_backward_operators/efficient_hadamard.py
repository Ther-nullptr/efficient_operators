...
class EfficientMemoryHadamardFunc(torch.autograd.Function):
    ...
    def forward(
        ...
        x2_outlier_compressed, x2_sub_outliner_compressed, scale2 = true_divide_outliner_suboutlinear_svd_compress(x2, outliner_2, scale_2, sub_outliner_bit_2, sub_outliner_ratio_2, L_2, R_2)
    ...
    def backward(ctx, grad_output, grad_outliner_1, grad_L1, grad_R1, grad_scale_1, grad_outliner_2, grad_L2, grad_R2, grad_scale_2):
        ...
        x1 = true_divide_outliner_suboutlinear_svd_decompress(x1_outlier_compressed, x1_sub_outliner_compressed, ctx.sub_outliner_bit_1, scale1, L=L_1, R=R_1)
        x2 = true_divide_outliner_suboutlinear_svd_decompress(x2_outlier_compressed, x2_sub_outliner_compressed, ctx.sub_outliner_bit_2, scale2, L=L_2, R=R_2)
...
class EfficientMemoryHadamard(torch.nn.Module):
    ...
    def forward(self, x1, x2):
        result, outliner_1, L_1, R_1, scale_1, outliner_2, L_2, R_2, scale_2 = EfficientMemoryHadamardFunc.apply(
            x1,
            x2,
