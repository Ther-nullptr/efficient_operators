...
class MixedGatedMLPFunc(torch.autograd.Function):
    ...
    def backward(ctx, grad_output: torch.Tensor):
        ...
        return grad_x1, None, None, None, grad_w_gate_lora_a, grad_w_gate_lora_b, None, None, None, grad_w_up_lora_a, grad_w_up_lora_b, None, None, None, grad_w_down_lora_a, grad_w_down_lora_b, None, None
    

class MixedGatedMLP(torch.nn.Module):
    def __init__(self, activation_forward='relu', activation_backward='relu', bias=False):
